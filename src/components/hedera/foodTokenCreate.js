...
async function treatTokenCreateFcn(walletData, accountId) {
	console.log(`\n=======================================`);
	console.log(`- Creating TREAT tokens for Hbargotchi...`);
	...
	console.log(`- Created TREAT token with ID: ${tId}`);

	return [tId, supply, tokenCreateSubmit.transactionId];
}

export default treatTokenCreateFcn;
